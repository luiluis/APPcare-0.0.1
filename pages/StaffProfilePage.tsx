  ...
  return (
    <div className="flex flex-col h-full animate-in fade-in">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 mb-6 overflow-hidden">
            <div className="p-6">
                {/* Header Limpo: Apenas Identidade e Navegação */}
                <div className="flex items-center gap-5 mb-6">
                    <button onClick={() => navigate('/rh')} className="p-2 hover:bg-gray-100 rounded-full text-gray-400"><ArrowLeft className="w-5 h-5"/></button>
