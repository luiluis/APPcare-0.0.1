               ...
               <div className="bg-white rounded-2xl shadow-2xl p-6 max-w-md w-full">
                   ...
                   <div className="space-y-4">
                       <div>
                           ...
                           <input 
                             disabled={isProcessing}
                             className="w-full border border-gray-300 rounded-lg px-4 py-2.5 outline-none focus:ring-2 focus:ring-blue-500 bg-white text-gray-900 font-medium disabled:bg-gray-50"
                       ...
                       <div>
                           ...
                           <select 
                             disabled={isProcessing}
                             className="w-full border border-gray-300 rounded-lg px-4 py-2.5 outline-none bg-white text-gray-900 font-medium disabled:bg-gray-50"
